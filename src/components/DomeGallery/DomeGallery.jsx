  ...
  const startAutoRotate = useCallback(() => {
    ...
    const step = ts => {
      const paused =
        ...
        (autoRotatePauseOnHover && hoverPausedRef.current);
    ...
    autoRotateRAF.current = requestAnimationFrame(step);
  }, [autoRotate, autoRotateSpeed, autoRotatePauseOnHover, stopAutoRotate]);

  const handleAutoRotateMouseEnter = useCallback(() => {
    if (autoRotatePauseOnHover) hoverPausedRef.current = true;
  }, [autoRotatePauseOnHover]);

  const handleAutoRotateMouseLeave = useCallback(() => {
  ...
  return (
    ...
    >
      <main
        ...
        onMouseEnter={handleAutoRotateMouseEnter}
        onMouseLeave={handleAutoRotateMouseLeave}
      >
        <div className="stage">
